...
parser.add_argument('--input_data_dir', type=str, default=Path('/kaggle/input'))
parser.add_argument('--dataset', type=str, default='geom-3d-nmol50000-nconf5-nupper1000')
...
parser.add_argument('--input_model_dir', type=str, default=Path('/kaggle/working/'))
